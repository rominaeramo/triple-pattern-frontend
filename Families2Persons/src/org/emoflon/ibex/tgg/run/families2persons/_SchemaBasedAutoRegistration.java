...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/Families2Persons/metamodels/Families.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/Families2Persons/metamodels/Persons.ecore");
	}
