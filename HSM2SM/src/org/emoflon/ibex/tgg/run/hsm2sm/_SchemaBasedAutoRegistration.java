...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/HSM2SM/metamodels/hsm.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/HSM2SM/metamodels/sm.ecore");
	}
